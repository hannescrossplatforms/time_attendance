...
Route::get('/hipjam_graph_data/{brand_id}', array('uses' => 'hipjam\HipjamController@graphData', 'as' => 'hipjam_graph_data'))->before('auth');
// User Management
...
Route::get('hippnp/picknpay_manage_store_categories/add_category','hippnp\HippnpController@addCategoryToStore');
Route::get('/hippnp/picknpay_manage_store_categories/remove_category/{id}', array('uses' => 'hippnp\HippnpController@removeCategoryFromStore', 'as' => 'hippnp_remove_category'))->before('auth');
...
Route::get('hippnp/getStoresForProvince/{id}','hippnp\HippnpController@getStoresForProvince');
Route::get('hippnp/getCategoriesForStoreBeacon/{id}','hippnp\HippnpController@getCategoriesForStoreBeacon');
...
Route::get('hipbidvest/bidvest_checklist_management','hipbidvest\HipbidvestController@bidvestChecklistManagement');
...
Route::get('/hipbidvest/bidvest_manage_store_categories/remove_category/{id}', array('uses' => 'hipbidvest\HipbidvestController@removeCategoryFromStore', 'as' => 'hipbidvest_remove_category'))->before('auth');
...
Route::get('hipbidvest/bidvest_delete_beacon/{id}', 'hipbidvest\HipbidvestController@deleteBeacon');
