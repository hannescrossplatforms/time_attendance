...
Route::any('/hippnp/picknpay_manage_store_categories/remove_category/{id}/{store_id}', array('uses' => 'hippnp\HippnpController@removeCategoryFromStore', 'as' => 'hippnp_remove_category'))->before('auth');
// Route::get('hippnp/picknpay_manage_store_categories/remove_category/{id}/{store_id}','hippnp\HippnpController@removeCategoryFromStore', 'as' => 'hippnp_remove_category');
