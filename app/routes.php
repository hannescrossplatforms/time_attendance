...
Route::match(['get','post'], array('uses' => 'ExportController@exportVicinityAsJSON', 'as' => 'export_vicinity_data_to_json'), '/vicinity_to_json', function (Illuminate\Http\Request $request) {
