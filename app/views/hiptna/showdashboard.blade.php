        ...
        <div class="col-md-2" >
            <div class="venuerow">
                <div class="modStat">
                    ...
                    <div id="staff_expected" class="modStatspan"><span style="font-size: 30%;">Loading...</span></div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            ...
            var chartProperties = {
                ...
                "rotatevalues": "1",
                "theme": "zune",
                "clickURL": "{{ url('/hiptna_showgraphdrilldown?period="+time+"&start="+startbase+"&end="+endbase+"#absence') }}"
            ...
            var chartProperties = {
                ...
                "rotatevalues": "1",
                "theme": "zune",
                "clickURL": "{{ url('/hiptna_showgraphdrilldown?period="+time+"&start="+startbase+"&end="+endbase+"#wsproximity') }}"
            };
