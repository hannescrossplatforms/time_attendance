...
@section('content')
  ...
  <body class="hipWifi">
    ...
    <form role="form" id="mainform" method="post" enctype="multipart/form-data"
        action=" @if ($edit) {{ url('hipwifi_editmedia'); }} @else {{ url('hipwifi_addmedia'); }} @endif ">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
      <h1 class="page-header">Login Page Manager</h1>
      @if ($errors->has())
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input id="dtimage" type="file" name="dtimage" form="dtimageform">
                          <a  id="dt-file" href="#" class="btn btn-default btn-sm  btn-block " 
...
<!--                   <label>Login Process <a href="#" data-toggle="modal" data-target="#loginProcessModal">( i )</a></label>
                ...
                <!-- Tab panes -->
                  ...
                  <!-- <div role="tabpanel" class="tab-pane active" id="loginFull"> -->
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input id="mbimage" type="file" name="mbimage" form="mbimageform">
                          <a  id="mb-file" href="#" class="btn btn-default btn-sm  btn-block " 
                              data-toggle="modal" data-target="#mobileBgModal"  > 
                              Upload new image
                          </a>
                        </input>
                      </div>
                    ...
                    <div class="clear"></div>
                    <br>
                    <a id="configButton" href="#" class="btn btn-default" data-toggle="modal" data-target="#configMobileModal"><i class="fa fa-gears"></i> Configuration</a>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <input  id="locationcode" name="location" class="form-control" type="text" 
                            value="{{$data['media']->location}}" disabled >
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
                      <div class="col-md-4">
                          <img src="/img/wifi_mobile_skin.png" class="img-responsive" />
                        </div>
                        <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <label class="radio-inline">
                        <input type="radio" name="welcome_flag" value="0" {{ $data['flag_off_checked']}}> Off
                      </label>
                    </div>

                    <div class="form-group">
                      <label>‘Entry field group’ position (offset from top) </label>
                      <input id="ef_group_pos" name="ef_group_pos" value = "{{$data['media']->ef_group_pos}}" type="text" class="form-control" >
                    </div>
                    <div class="form-group">
                      <label>‘Entry field’ Transparency level (0% to 100%)</label>
                      <input id="ef_transparency" name="ef_transparency" value = "{{$data['media']->ef_transparency}}" type="text" class="form-control" >
                    </div>
                    <div class="form-group">
                      <label>‘Background’ Colour </label>
                      <input class="input-big" id="bg_colour" name="bg_colour" type="color" value='{{$data['media']->bg_colour}}'>
                    </div>
                    <div class="form-group">
                      <label>‘Entry field’ Colour </label>
                      <input class="input-big" id="ef_colour" name="ef_colour" type="color" value='{{$data['media']->ef_colour}}'>
                    </div>
                    <div class="form-group">
                      <label>‘Entry field’ Outline and Text colour </label>
                      <input class="input-big" id="ef_outline_text_colour" name="ef_outline_text_colour" type="color" value='{{$data['media']->ef_outline_text_colour}}'>
                    </div>
                    <div class="form-group">
                      <label>Zone In Button gap to ‘Entry field group’ </label>
                      <input id="zonein_gap" name="zonein_gap" value="{{$data['media']->zonein_gap}}" type="text" class="form-control" placeholder="100px">
                    </div>
                    <div class="form-group">
                      <label>Zone In Button colour </label>
                      <input class="input-big" id="zonein_btn_colour" name="zonein_btn_colour" type="color" value='{{$data['media']->zonein_btn_colour}}'>
                    </div>
                    <div class="form-group">
                      <label>Zone In Button – text colour </label>
                      <input class="input-big" id="zone_txt_colour" name="zone_txt_colour" type="color" value='{{$data['media']->zone_txt_colour}}'>
                    </div>
                    <div class="form-group">
                      <label>FAQ |SUPPORT & Powered By - Text Colour</label>
                      <input class="input-big" id="faq_colour" name="faq_colour" type="color" value='{{$data['media']->faq_colour}}'>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="radio-inline">
                        <input type="radio" id="logo_choice" name="logo_choice" value="black" {{ $data['logo_choice_black']}}> Black
                      </label>
                    </div>
                        </div>
                    </div>
  ...
  $('a.fancybox').fancybox();
   ...
   <script>
      ...
      $(function() {
        ...
        @if ($edit) $('#dtfunction').click(); @endif
        @if ($edit) $('#mbfunction').click(); @endif
      ...
      var dtwrapper = $('<div/>').css({height:0,width:0,'overflow':'hidden'});
