    <div class="col-sm-3 col-md-3 sidebar sidebarActive">
      ...
      <ul class="nav nav-sidebar nav-products">
        ...
        <li class="li-reports" class="active"><a href="{{ url('hipreports_showdashboard'); }}"><i class="fa fa-bar-chart"></i></a></li>
        @endif
...
<!--        <li @if ( $data['currentMenuItem'] == "Dashboard" ) class="active" @endif><a href="{{ url('hipreports_showdashboard'); }}"><i class="fa fa-dashboard"></i>Dashboard</a></li>-->
        <li @if ( $data['currentMenuItem'] == "HipWifi" ) class="active" @endif><a href="{{ url('hipreports_hipwifi'); }}"><i class="fa fa-wifi"></i>WIFI</a></li>

<!--         <li @if ( $data['currentMenuItem'] == "HipRm" ) class="active" @endif><a href="{{ url('hipreports_hiprm'); }}"><i class="fa fa-credit-card"></i>HipRM</a></li>
        <li @if ( $data['currentMenuItem'] == "HipJam" ) class="active" @endif><a href="{{ url('hipreports_hipjam'); }}"><i class="fa fa-shopping-cart"></i>HipJAM</a></li>
        <li @if ( $data['currentMenuItem'] == "HipEngage" ) class="active" @endif><a href="{{ url('hipreports_hipengage'); }}"><i class="fa fa-bullhorn"></i>HipENGAGE</a></li> -->

      </ul>
      
      <div class="clearfix"></div>
    </div>
        <script> currentProduct = "hipREPORTS"; </script>
