          ...
          <div class="card-body collapse show" id="metrics">
            <div class="row">
              ...
              <div class="col-xl-2 col-lg-2 col-md-4">
                ...
                <select id="master_graph_chart_location" class="form-control">
                  <option value="0">All</option>
                  @foreach ($data['all_venues'] as $venue)
                    @if ($venue->track_type == 'billboard')
                      <option data-track-type="ooh" value="{{$venue->id}}">{{isset($venue->friendly_brandname) ? $venue->friendly_brandname.' '.explode(" ", $venue->sitename)[count(explode(" ", $venue->sitename))-1] : $venue->sitename}}</option>
                    @else
                      <option data-track-type="venue" disabled="disabled" value="{{$venue->id}}">{{isset($venue->friendly_brandname) ? $venue->friendly_brandname.' '.explode(" ", $venue->sitename)[count(explode(" ", $venue->sitename))-1] : $venue->sitename}}</option>
                    @endif
                  @endforeach
                </select>
              </div>
            ...
            <!-- <div class="row">
              ...
              <!-- <div id='ooh_metric_options' class="col-11">
                <input data-data-type="int" class="selectable-metric" id="fil_total_reach" type="checkbox" value="total_reach" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Total Reach</span>
                <input data-data-type="perc" class="selectable-metric" id="fil_new_reach_rate" type="checkbox" value="new_reach_rate" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">New Reach Rate</span>
                <input data-data-type="perc" class="selectable-metric" id="fil_return_reach_rate" type="checkbox" value="return_reach_rate" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Return Reach Rate</span>
                <input data-data-type="int" class="selectable-metric" id="fil_reach_frequency" type="checkbox" value="reach_frequency" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Frequency</span>
                <input data-data-type="int" class="selectable-metric" id="fil_gross_rate_point" type="checkbox" value="gross_rate_point" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Gross Rate Point</span>
                <input data-data-type="int" class="selectable-metric" id="fil_average_dwell_time" type="checkbox" value="average_dwell_time" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Average Dwell Time</span> <br />
                <input data-data-type="perc" class="selectable-metric" id="fil_strike_rate" type="checkbox" value="strike_rate" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Strike Rate</span>
                <input data-data-type="int" class="selectable-metric" id="fil_strike_time" type="checkbox" value="strike_time" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Strike Time</span>
                <input data-data-type="int" class="selectable-metric" id="fil_strike_distance" type="checkbox" value="strike_distance" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Strike Distance</span>
                <input data-data-type="int" class="selectable-metric" id="fil_potential_sales" type="checkbox" value="potential_sales" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Potential Sales</span>
                <input data-data-type="perc" class="selectable-metric" id="fil_roi" type="checkbox" value="roi" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">ROI</span>
                <input data-data-type="int" class="selectable-metric" id="fil_cpa" type="checkbox" value="cpa" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">CPA</span>

              </div> -->

              <!-- <div id='venue_metric_options' class="col-11" style="display: none;">
                <input data-data-type="int" class="selectable-metric" id="fil_total_customers_in_store" type="checkbox" value="total_customers_in_store" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Total Custmers in Store</span>
                <input data-data-type="int" class="selectable-metric" id="fil_new_customers_in_store" type="checkbox" value="new_customers_in_store" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">New Custmers in Store</span>
                <input data-data-type="int" class="selectable-metric" id="fil_returning_customers_in_store" type="checkbox" value="returning_customers_in_store" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Returning Customers in Store</span>
                <input data-data-type="int" class="selectable-metric" id="fil_total_conversions" type="checkbox" value="total_conversions" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Total Conversions</span>
                <input data-data-type="perc" class="selectable-metric" id="fil_conversion_rate" type="checkbox" value="conversion_rate" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Conversion Rate</span>
                <input data-data-type="perc" class="selectable-metric" id="fil_bounce_rate" type="checkbox" value="bounce_rate" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Bounce Rate</span>
                <input data-data-type="int" class="selectable-metric" id="fil_high_dwell_customers" type="checkbox" value="high_dwell_customers" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">High Dwell Customers</span>
                <input data-data-type="int" class="selectable-metric" id="fil_average_time_spent_in_store" type="checkbox" value="average_time_spent_in_store" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Average Time Spent in Store</span>
              </div>
            </div> -->
        ...
        <div class="card card-default card-demo">
          ...
          <div class="card-body collapse show" id="regional_metrics">
            <div class="row">
              ...
              <div class="col-xl-2 col-lg-2 col-md-4">
                <small>Type:</small> <br />
                <select id="regional_metrics_graph_type" class="form-control">
                  <option value="ooh">OOH Site</option>
                  <option value="venue">Venue</option>
                </select>
              </div>
              <div class="col-xl-2 col-lg-2 col-md-4">
                <small>Span:</small> <br />
                <select id="regional_metrics_graph_span" class="form-control">
                  <option value="this_week">This Week</option>
                  <option value="yesterday">Yesterday</option>
                  <option value="today">Today</option>
                  <option value="last_week">Last Week</option>
              ...
              <div class="col-xl-2 col-lg-2 col-md-4">
                <small>Group By:</small> <br />
                <select id="regional_metrics_group_by" class="form-control">
              ...
              <div class="col-xl-2 col-lg-2 col-md-4">
                <small>Chart Type:</small> <br />
                <select id="regional_metrics_chart_type" class="form-control">
                  <option value="bar">Bar</option>
                  <option value="line">Stacked Bar</option>
                </select>
              </div>
            ...
            <!-- <div class="row">
              ...
              <div id='regional_ooh_metric_options' class="col-11">
                <input data-data-type="int" class="regional-selectable-metric" id="regional_fil_total_reach" type="checkbox" value="total_reach" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Total Reach</span>
                <input data-data-type="perc" class="regional-selectable-metric" id="regional_fil_new_reach_rate" type="checkbox" value="new_reach_rate" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">New Reach Rate</span>
                <input data-data-type="perc" class="regional-selectable-metric" id="regional_fil_return_reach_rate" type="checkbox" value="return_reach_rate" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Return Reach Rate</span>
                <input data-data-type="perc" class="regional-selectable-metric" id="regional_fil_strike_rate" type="checkbox" value="strike_rate" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Strike Rate</span>
                <input data-data-type="int" class="regional-selectable-metric" id="regional_fil_strike_time" type="checkbox" value="strike_time" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Strike Time</span>
                <input data-data-type="int" class="regional-selectable-metric" id="regional_fil_strike_distance" type="checkbox" value="strike_distance" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Strike Distance</span>
                <input data-data-type="perc" class="regional-selectable-metric" id="regional_fil_roi" type="checkbox" value="roi" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">ROI</span>
                <input data-data-type="int" class="regional-selectable-metric" id="regional_fil_cpa" type="checkbox" value="cpa" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">CPA</span>

              </div>

              <div id='regional_venue_metric_options' class="col-11" style="display: none;">
                <input data-data-type="int" class="regional-selectable-metric" id="regional_fil_total_customers_in_store" type="checkbox" value="total_customers_in_store" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Total Custmers in Store</span>
                <input data-data-type="int" class="regional-selectable-metric" id="regional_fil_new_customers_in_store" type="checkbox" value="new_customers_in_store" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">New Custmers in Store</span>
                <input data-data-type="int" class="regional-selectable-metric" id="regional_fil_returning_customers_in_store" type="checkbox" value="returning_customers_in_store" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Returning Customers in Store</span>
                <input data-data-type="perc" class="regional-selectable-metric" id="regional_fil_conversion_rate" type="checkbox" value="conversion_rate" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Conversion Rate</span>
                <input data-data-type="int" class="regional-selectable-metric" id="regional_fil_high_dwell_customers" type="checkbox" value="high_dwell_customers" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">High Dwell Customers</span>
                <input data-data-type="int" class="regional-selectable-metric" id="regional_fil_total_conversions" type="checkbox" value="total_conversions" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Total Conversions</span>
                <input data-data-type="int" class="regional-selectable-metric" id="regional_fil_average_time_spent_in_store" type="checkbox" value="average_time_spent_in_store" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Average Time Spent in Store</span>
                <input data-data-type="perc" class="regional-selectable-metric" id="regional_fil_bounce_rate" type="checkbox" value="bounce_rate" style="margin-right:4px;"><span style="margin-right: 10px; position: relative; top: -2px;">Bounce Rate</span>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-12">
                <div id="regional_dashboard_master_chart" style="height:500px;"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-6">
        <div class="card card-default card-demo" id="cardChart9">
          <div class="card-header">
            ...
            <a class="float-right" href="javascript:void(0);" data-tool="card-collapse" data-toggle="tooltip" title="" data-original-title="Collapse card"><em class="fa fa-minus" style="color: #c1c2c3;"></em></a>
            ...
            <div class="card-wrapper">
              <div class="row">
                <div class="col-12" style="height: 250px;">
                  <div id="worst-performing-chart" style="height: 100%"></div>
                </div>
              </div>
            </div>
          </div>
...
<script>
  ...
  liveJam.initialize = (callback) => {
    $.getScript('https://www.gstatic.com/firebasejs/7.1.0/firebase-firestore.js', () => {
      ...
      $.each(loaded_venues, function(i, v) {
        venue_array.push(liveJam.db.collection(v.id));
      });
    ...
    $.each(loaded_venues, (num, venue) => {
      $.each(date_array, (n, date) => {
        best_worst_venue_promises.push(
          liveJam.db.collection(venue.id).doc(date).get()
          .then(doc => {
            ...
            if (doc.data() !== undefined) {
              ...
              // debugger;
              return {
                label: (venue.friendly_brandname !== null ? (`${venue.friendly_brandname} ${venue.sitename.split(' ')[1]}`) : venue.sitename),
                value: doc.data().customers_in_store_today
              };
            } else {
              return {
                label: (venue.friendly_brandname !== null ? (`${venue.friendly_brandname} ${venue.sitename.split(' ')[1]}`) : venue.sitename),
  ...
  function getIcon(venue, callback) {
    ...
    liveJam.db.collection(venue.id).doc(current_date_node).get()
      .then((doc) => {
        if (doc.exists) {
      ...
      promise_array.push(firebase.firestore().collection(id).doc(date).get().then(function(doc) {
        if (doc.exists) {
          ...
          promise_array.push(firebase.firestore().collection(id).doc(date).collection('hourly').get().then(function(col) {
            let hourly = {
              hourly: $.map(col.docs, function(d, i) {
                return {
                  [d.id]: d.data()
                }
              })
  ...
  function getDateArray() {
    ...
    if (filters === null) {
      filters = {
        date_from: moment().startOf('week').add(1, 'day'),
...
<script>
  ...
  function get_presets() {
    ...
    return {
      ...
      date_from: get_query_string_key('date_from'),
      date_to: get_query_string_key('date_to'),
      venue_id: get_query_string_key('venue_id')
    }
  }
...
<script>
  ...
  $('.collapse').on('shown.bs.collapse', function(event) {
          $($($($(this).parent().children()[0]).children()[1]).children()[0]).toggleClass('fa-minus fa-plus')
