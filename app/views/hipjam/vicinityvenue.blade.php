...
<section class="section-container">
  ...
  <div class="content-wrapper">
    <div class="content-heading">
      <div data-venue="{{$data['venue']->sitename}}">Edit Track Venue - {{$data['venue']->sitename}}</div>
      @if ($errors->has())
              ...
              <hr />
                ...
                <div class="row">
                  {{ Form::hidden('id', $data['venue']->id) }}
                    ...
                    <div class="col-6 text-left">
                      <div class="form-group">
                        <label for="billboard_retail">OOH Site / Retaiils</label>
                    ...
                    <div class="col-6 text-left">
                      <div class="form-group">
                        ...
                        @if ($data['venue']->track_type == 'billboard' && $data['venue']->sitename == 'SBOutdoor MeadowdaleR24')
                        ...
                        @elseif ($data['venue']->track_type == 'billboard' && $data['venue']->sitename == 'SBOutdoor MichelleAve')
                        ...
                        @elseif ($data['venue']->track_type == 'billboard' && $data['venue']->sitename == 'SBOutdoor PWC')
                        ...
                        @elseif ($data['venue']->track_type == 'billboard' && $data['venue']->sitename == 'SBOutdoor RandViewCentre')
                        ...
                        @elseif ($data['venue']->track_type == 'billboard' && $data['venue']->sitename == 'SBOutdoor SephakoMakgathoDr')
                        ...
                        @elseif ($data['venue']->track_type == 'billboard' && $data['venue']->sitename == 'SBOutdoor StoneridgeDrive')
                    ...
                    <div class="col-md-6 text-left">
                      ...
                      <div class="form-group" id="advertising_cost_container" style="display: none;">
                        <label for="advertising_cost">Advertising Cost</label>
                        <input id="advertising_cost" type="text" class="form-control" name="advertising_cost" placeholder="0.00" value="{{$data['venue']->advertising_cost}}" required>
                      </div>
                        ...
                        <?php if (!empty($data['sensors'])) {
                          foreach ($data['sensors'] as $sensor) { ?>
                            <tr id="row{{$sensor->id}}">
                              ...
                              <td width="20%">
                                <a onclick="updateServerRow({{$sensor->id}});" class="btn btn-primary no-radius btn-delete btn-sm" style="color: white;">Update</a>
...
<script>
  ...
  function generateFormData() {
    ...
    data['advertising_cost'] = $('#advertising_cost').val();
  ...
  function showLinkVenueToBillboard() {
    ...
    if (selected_track_id === 'venue') {
      ...
      advertising_cost.slideDown('fast');
