...
<section class="section-container">
  ...
  <div class="content-wrapper">
    <div class="content-heading">
      <div>@if ($is_activation) Activate @else Edit @endif Track Venue - {{$data['venue']->sitename}}</div>
      @if ($errors->has())
            ...
            <div class="row">
              ...
              <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" id="servertab" class="nav-item"><a id="absencetab" href="#venue" aria-controls="absence" role="tab" data-toggle="tab">Sensors</a></li>
                    <li role="presentation" id="heatmaptab" class="nav-item"><a id="wsproximitytab" href="#heatmap" aria-controls="wsproximity" role="tab" data-toggle="tab">
                        Heatmap
                      </a></li>
                    @else
                    <li role="presentation" id="generaltab" class="nav-item"><a id="generaltab" href="#general" aria-controls="general" role="tab" data-toggle="tab" class="nav-link active">General</a></li>
                    <li role="presentation" id="servertab" class="nav-item"><a id="absencetab" href="#venue" aria-controls="absence" role="tab" data-toggle="tab" class="nav-link">Sensors</a></li>
                    <li role="presentation" id="heatmaptab" class="nav-item"><a id="wsproximitytab" href="#heatmap" aria-controls="wsproximity" role="tab" data-toggle="tab" class="nav-link">
                        Heatmap
                      </a></li>
                    @endif
                  </ul>
                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane <?php if ($data['user'] == 'superadmin') {echo ' active';} ?>" id="general">
                      ...
                      <div class="form-group">
                        ...
                        @if ($data['venue']->sitename == 'SBOutdoor MeadowdaleR24')
                        ...
                        @elseif ($data['venue']->sitename == 'SBOutdoor MichelleAve')
                        <input disabled id="track_slug" type="text" class="form-control" name="track_slug" placeholder="" value="b6296d42-8682-4137-aef6-f705ba94fbbf">
                        @elseif ($data['venue']->sitename == 'SBOutdoor PWC')
                        ...
                        @elseif ($data['venue']->sitename == 'SBOutdoor RandViewCentre')
                        ...
                        @elseif ($data['venue']->sitename == 'SBOutdoor SephakoMakgathoDr')
                        ...
                        @elseif ($data['venue']->sitename == 'SBOutdoor StoneridgeDrive')
                    ...
                    <div role="tabpanel" class="tab-pane <?php if ($data['user'] != 'superadmin') {
                                                            echo ' active';
                                                          } ?>" id="venue">
                              ...
                              <?php if (!empty($data['sensors'])) {
                                foreach ($data['sensors'] as $sensor) { ?>
                                  <tr id="row{{$sensor->id}}">
                                    ...
                                    @endif
                                    <td width="17%">
                                      <a style="color:white;" onclick="updateServerRow({{$sensor->id}});" class="btn btn-primary no-radius btn-delete btn-sm">Update</a>
                    ...
                    <div role="tabpanel" class="tab-pane" id="heatmap">
                      <div class="clear">
                        <div class="row">
                          ...
                          <form role="form" id="useradmin-form" method="post" action=" @if ($is_activation) {{ url('hipjam_activatevenue'); }} @else {{ url('hipjam_editvenue'); }} @endif ">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <input id="sitename" type="text" class="form-control" id="exampleInputEmail1" name="sitename" placeholder="" value="@if(Input::old('sitename')){{Input::old('sitename')}}@else{{$data['venue']->sitename}}@endif" required disabled>
                                </div>
                                          ...
                                          <div class="row">
                                            <div class="col-md-4">
                                              <div class="form-group">
                                                ...
                                                <a id="fp-file" href="#" class="btn btn-default btn-sm  btn-block " data-toggle="modal" data-target="#desktopBgModal">
                                                  Upload new image
                                                </a>
                                                </input>
                                            ...
                                            <table class="tnastafftable" id="sensortable">
                                              <thead>
                                                <tr>
                                                  ...
                                                  <th class="tnastafftd_add_update" style="width:16%;">
                                                    <!-- <a id="addreportuser"  class="btn btn-default btn-delete btn-sm" href="javascript:void(0);" onclick="addMoreRows(this.form);" >Add</a> -->
                                                  </th>
...
<script>
  ...
  $('#dtpreview').click(function() {
    ...
    var url = 'http://hiphub.hipzone.co.za/hipjam_previewsensors';
    $.ajax({
      type: "POST",
      dataType: 'json',
      url: url,
  ...
  $(function() {
    ...
    if ($('#mon_from').val() == "Closed") {
      $('#mon_to').hide();
    };
    if ($('#tue_from').val() == "Closed") {
      $('#tue_to').hide();
    };
    if ($('#wed_from').val() == "Closed") {
      $('#wed_to').hide();
    };
    if ($('#thu_from').val() == "Closed") {
      $('#thu_to').hide();
    };
    if ($('#fri_from').val() == "Closed") {
      $('#fri_to').hide();
    };
    if ($('#sat_from').val() == "Closed") {
      $('#sat_to').hide();
    };
    if ($('#sun_from').val() == "Closed") {
      $('#sun_to').hide();
    };


    $('#mon_to, #tue_to, #wed_to, #thu_to, #fri_to, #sat_to, #sun_to').timepicker({
      'timeFormat': 'H:i'
    });
