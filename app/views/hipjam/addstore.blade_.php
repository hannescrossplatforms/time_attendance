    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
            <h1 class="page-header">@if ($edit) Edit @else Add @endif  Track Venue - {{$data['venue']->sitename}}</h1>
            @if ($errors->has())
    ...
    <div class="container-fluid">
            ...
            <!-- Nav tabs -->
              ...
              @if ($data['user'] != 'superadmin') 
                <li role="presentation" id="servertab" class="active"><a id="absencetab" href="#store" aria-controls="absence" role="tab" data-toggle="tab">Sensors</a></li>
              ...
              @else 
                ...
                <li role="presentation" id="servertab"><a id="absencetab" href="#store" aria-controls="absence" role="tab" data-toggle="tab">Sensors</a></li>
                <li role="presentation" id="heatmaptab"><a id="wsproximitytab" href="#heatmap" aria-controls="wsproximity" role="tab" data-toggle="tab">
                Heatmap
                </a></li>
              @endif
      ...
      <div role="tabpanel" class="tab-pane <?php if($data['user'] == 'superadmin'){echo ' active'; } ?>" id="general">
        ...
        action="{{ url('hipjam_editvenueserver'); }}"> -->
                  ...
                  <br>
              <button id="submitform_gen" class="btn btn-primary">Submit</button>
              <a href="{{ url('hipjam_showstores'); }}" class="btn btn-primary pull-right">Done</a>
          <!-- </form> -->
        </div>            
      </div>
      <div role="tabpanel" class="tab-pane <?php if($data['user'] != 'superadmin'){echo ' active'; } ?>" id="store">
        ...
        <div class="row">
                      ...
                      <div class="table-responsive">  
                        ...
                        <tr>
                         ...
                         {{-- <td> <select id="sensor_vpnip" class="form-control no-radius" placeholder=" Select sensor vpnip">
                               @foreach($data['vpnips'] as $ip)
      ...
      <form role="form" id="useradmin-form" method="post"
        action=" @if ($edit) {{ url('hipjam_editvenue'); }} @else {{ url('hipjam_addvenue'); }} @endif ">
          ...
          if(!newrecord['track_slug']) {
            ...
            $.ajax({
                ...
                success:  function(objResult){
                  ...
                  $("#servertab").removeClass("disabled").find("a").attr("href", "#store");
