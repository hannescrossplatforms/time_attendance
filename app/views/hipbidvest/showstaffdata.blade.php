  ...
  <body class="hipTnA">
    ...
    <script>
        ...
        $('#selectedDate').change(function () {
            ...
            $.ajax({
                url: pathname + 'hipbidvest/periodchartJsondataStaffAjax',
                type: 'get',
                dataType: 'json',
                data: {
                    'date': date
        ...
        function get_staff_category_details(staffId, date){
            ...
            $.ajax({
                url: pathname + 'hipbidvest/staffCategoryActivity',
                type: 'POST',
                dataType: 'json',
                data: {
                    'date': date,
        ...
        function get_staff_chart(){
            ...
            if (text != "Select"){
                ...
                $.ajax({
                    url: pathname + 'hipbidvest/periodchartJsondataSingleStaffAjax',
                    type: 'post',
                    dataType: 'json',
                    data: {
                        'date': date,
