...
class Advertmedia extends Eloquent implements UserInterface, RemindableInterface {
...
use UserTrait, RemindableTrait;
   ...
   /* public function getAdvertMedias() {
    ...
    public function getadvertmedia($id){

        $advertmedias = \Advertmedia::where('brand_id', $id)->get();

        return $advertmedias;
    }

    public function deleteadvertmedia($id){
